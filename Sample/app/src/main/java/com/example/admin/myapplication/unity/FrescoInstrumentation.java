...
/**
 * Tracks state of image request.  监控图片请求的状态
 *
 * <p/> Components that implement { FrescoInstrumented} interface can use this class to track their
 * requests.
 */
public class FrescoInstrumentation {
  ...
  /**
   * InstrumentedDraweeView对象，在构造的时候传递过来的
   */
  ...
  private String mTag;  //存放URL
  private long mFinishTime;
  private ImageRequestState mState;

  public FrescoInstrumentation(View view) {
    mPaint = new Paint();
    mTextRect = new Rect();
    mView = view;
